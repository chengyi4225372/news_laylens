...
-- Records of company
-- ----------------------------
INSERT INTO `company` VALUES ('0000000007', '/static/upload/0e6e125347dd0058/3f8e0a15845522e4.jpg', '333333', '3333333333', '33333333333', '2019-01-19 09:39:12');
...
CREATE TABLE `pic` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `imgs_1` varchar(200) DEFAULT NULL,
  `imgs_2` varchar(200) DEFAULT NULL,
  `imgs_3` varchar(200) DEFAULT NULL,
  `imgs_4` varchar(200) DEFAULT NULL,
  `imgs_5` varchar(200) DEFAULT NULL,
  `imgs_6` varchar(200) DEFAULT NULL,
  `imgs_7` varchar(200) DEFAULT NULL,
  `imgs_8` varchar(200) DEFAULT NULL,
  `imgs_9` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=146 DEFAULT CHARSET=utf8 COMMENT='系统菜单表';
...
INSERT INTO `system_menu` VALUES ('139', '117', 'about(关于)', '', '', '#', '', '_self', '0', '1', '0', '2019-01-18 10:44:32');
INSERT INTO `system_menu` VALUES ('140', '139', 'company profile(公司简介)', '', '', '/tuanj/about/index', '', '_self', '0', '1', '0', '2019-01-18 10:45:28');
INSERT INTO `system_menu` VALUES ('141', '139', '新闻（news）', '', '', '/tuanj/information/index', '', '_self', '0', '1', '0', '2019-01-18 13:35:43');
INSERT INTO `system_menu` VALUES ('142', '139', '经销商(Distributor)', '', '', '/tuanj/distributor/index', '', '_self', '0', '1', '0', '2019-01-19 10:37:26');
INSERT INTO `system_menu` VALUES ('143', '139', 'highlights(亮点)', '', '', '/tuanj/highlight/index', '', '_self', '0', '1', '0', '2019-01-19 14:14:26');
INSERT INTO `system_menu` VALUES ('144', '117', '导航栏', '', '', '/tuanj/daohang/index', '', '_self', '0', '1', '0', '2019-01-24 16:58:25');
INSERT INTO `system_menu` VALUES ('145', '139', '专利(patents)', '', '', '/tuanj/patents/index', '', '_self', '0', '1', '0', '2019-01-26 13:27:47');
