...
class Thingsinfo extends BasicAdmin {

    private $dataform = 'things_info';

//    private $cate = 'news_cate';

    public function index() {
        $this->title = '考虑的事情具体详情设置';
    ...
    protected function _form_result($result) {
        if ($result !== false) {
            list($base, $spm, $url) = [url('@admin'), $this->request->get('spm'), url('tuanj/thingsinfo/index')];
