...
class Training extends BasicAdmin
{

    private $dataform = 'training';

    public function index() {
        $this->title = 'training center(培训中心)';
    ...
    protected function _form_result($result) {
        if ($result !== false) {
            list($base, $spm, $url) = [url('@admin'), $this->request->get('spm'), url('tuanj/training/index')];
