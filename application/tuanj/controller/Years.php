...
class Years extends BasicAdmin
{
    private  $dataform ='years';
    ...
    public  function index(){
        ...
        return parent::_list($db->order('year desc'));
    }
    /**
     * 添加
     * @return type
    ...
    protected function _form_result($result) {
        if ($result !== false) {
            list($base, $spm, $url) = [url('@admin'), $this->request->get('spm'), url('tuanj/years/index')];
