...
class Downloading extends BasicAdmin
{

    private $dataform = 'downloading';

    public function index() {
        $this->title = 'downloading(下载中心)';
    ...
    protected function _form_result($result) {
        if ($result !== false) {
            list($base, $spm, $url) = [url('@admin'), $this->request->get('spm'), url('tuanj/downloading/index')];
